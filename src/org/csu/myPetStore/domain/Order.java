...
public class Order implements Serializable {
  ...
  public void initOrder(Account account, CartShow cartShow) {
    ...
    for(int i =0 ;i < cartItemShowList.size();i++)
    {
      ...
      addLineItem((cartItemShow));
    }
  }

  public void addLineItem(CartItemShow cartItemShow) {
    LineItem lineItem = new LineItem(cartItemShow);
